  ...
  return (
    <main className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 sm:py-12">
      ...
      <footer className="mt-14 border-t border-[var(--line)] pt-6 text-xs leading-relaxed text-[var(--muted)]">
        Research system only — not a public live forecast. Independents without a
        Democratic nominee still count toward Democratic seat totals. Display
        ratings follow model P(Dem). ALFRED / OpenFEC use live APIs when keyed.
        Ratings/Kalshi overlays default on (`--no-ratings` / `--no-markets`).
        House is out of scope.
      </footer>
    </main>
  );
}
